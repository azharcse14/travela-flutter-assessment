...
class CustomPhoneField extends StatefulWidget {
  ...
  const CustomPhoneField({
    ...
    this.magnifierConfiguration, required this.onTapOutside,
  }) : super(key: key);
...
class _CustomPhoneFieldState extends State<CustomPhoneField> {
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      _selectedCountry = _countryList.firstWhere((item) => item.code == (widget.initialCountryCode ?? 'BD'),
          orElse: () => _countryList.first);
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage('assets/images/flags/${_selectedCountry.code.toLowerCase()}.png'),
                        fit: BoxFit.cover,
