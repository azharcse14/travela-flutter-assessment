...
class ColorManager {
  static Color colorPrimaryLight = const Color(0xff3669C9);
  static Color colorPrimaryDark = const Color(0xff3669C9);

  static Color colorSecondaryLight = const Color(0xCC3669C9);
  static Color colorSecondaryDark = const Color(0xCC3669C9);
  ...
  static Color kBaseColor = const Color(0xFFE81478);
  static Color kNavColor = const Color(0xFF666870);
